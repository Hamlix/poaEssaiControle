...
public class EnsembleRessources {
    // Permet la représentation d’un ensemble de ressources disponibles(entiers>0)
    // ou d ’un ensemble de ressources requises (entiers>= 0)
    // ou d ’un ensemble de production(entiers>=0) et de consommation(entiers<0)

    // PARTIE 1
    private Map<TypeRessource , Integer> ressources;
    public EnsembleRessources () { ressources = new HashMap<>(); }
